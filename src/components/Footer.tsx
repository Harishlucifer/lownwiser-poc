      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Welcome to Loan In Pocket, an RBI-registered Non-Banking Financial Company (NBFC) headquartered in Delhi, serving clients across India. We empower individuals and businesses with quick, hassle-free online loans that require minimal documentation, ensuring seamless access to short-term financial solutions.
            </p>
        ...
        <div className="border-t border-gray-700 pt-8 text-center">
          ...
          <p className="mt-12 text-xs text-gray-500">
            &copy; 2025 Loan In Pocket. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
