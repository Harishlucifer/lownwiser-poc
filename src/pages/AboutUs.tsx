                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 text-sm leading-relaxed mb-8">
                                At Loan In Pocket, we go beyond finance—we build relationships founded on trust, transparency, and unwavering support. Our tagline, "RISE AGAIN," embodies our mission to help you overcome financial challenges and move forward with confidence. Whether you need emergency funds, personal loans, or fast credit solutions, we stand by you every step of the way, providing reliable financial assistance when you need it most.
                            </p>
                            <Link
                                to="/apply-now"
