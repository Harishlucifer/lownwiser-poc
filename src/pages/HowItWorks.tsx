...
const steps = [
    {
        ...
        desc: "Getting started with Loan In Pocket is simple! Fill out a quick online application form with your basic details, desired loan amount, and monthly income. Our seamless digital process ensures that this step takes just a few minutes of your time.",
    },
    {
        number: "02",
