      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 max-w-5xl space-y-16">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-6 text-gray-800">Eligibility Criteria For Loan In Pocket</h3>
            ...
            {/* Key Features */}
            <div>
              <h3 className="text-2xl font-bold mb-6 text-gray-800">Key Features Of Loan In Pocket</h3>
              <ul className="list-disc pl-6 space-y-3 text-gray-600 text-sm">
