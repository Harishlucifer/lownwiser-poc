...
const slides = [
    ...
    },
    {
        ...
        desc: "Whether it's a medical emergency or an unexpected expense, Loan In Pocket provides fast and reliable financial solutions with complete transparency and customer-first service.",
    },
    {
        id: 3,
        title: "Transparent, Trusted Loans",
        subtitle: "For Every Situation",
        desc: "With Loan In Pocket, you can count on secure, hassle-free loan approvals, offering quick financial support for urgent needs, all with complete transparency and no hidden fees.",
    },
];
...
const offerCards = [
    {
        ...
        desc: "Don't let a cash crunch stop your shopping plans. With Loan In Pocket's quick online loans, you can get instant funds to shop freely and manage expenses without stress. Whether it's festival shopping, gadgets, or lifestyle purchases, we've got you covered.",
    },
    {
    ...
    },
    {
        ...
        desc: "Managing multiple bills? Consolidate and clear your credit card bills, utility payments, insurance premiums, and more with an easy personal loan from Loan In Pocket. One quick application, fast disbursal, and you're back in control of your finances.",
    },
    {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div className="flex flex-col justify-center p-10 md:p-16 bg-gray-50">
                        <h2 className="text-3xl font-extrabold text-gray-900 mb-4">
                            About Loan In Pocket: A Quick Insight
                        </h2>
